    ...
    const whyuxReply = {
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterName: `    ɴᴇɴᴏ ᴅᴠᴇ ɪꜱ 📡 ᴏɴʟɪɴᴇ `,
...
case 'getpp': {
    ...
    if (!phoneNumber) {
        return reply('Please provide a valid number or reply/tag the number you want to get the profile picture of. Example: `getpp +94721594279`');
    }
    try {
